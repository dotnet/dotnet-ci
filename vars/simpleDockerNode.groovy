...
def call(String dockerImageName, String hostVersion, int timeoutInMinutes, String dockerArgs, Closure body) {
	...
	def call(String dockerRegistryUrl, String registryCredentialsId, String dockerImageName, String hostVersion, int timeoutInMinutes, String dockerArgs, Closure body) {
    node (Agents.getDockerAgentLabel(hostVersion)) {
        timestamps {
            timeout(timeoutInMinutes) {
